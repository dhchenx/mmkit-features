...
if __name__ == "__main__":
    ...
    for id in content_ids:
        ...
        objgraph.show_refs([mmf_node], filename=f'images/node_{id}.png')
    ...
    # objgraph.show_refs([feature_lib], filename='sample-graph.dot')
    # objgraph.show_backrefs([feature_lib], filename='sample-backref-graph.png')
