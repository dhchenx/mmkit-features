...
import cv2
import mmkfeatures.video.models.raft.raft_src.utils.flow_viz as flow_viz
import numpy as np
import torch
import torchvision.transforms as transforms
from mmkfeatures.video.models.raft.raft_src.raft import RAFT, InputPadder
from mmkfeatures.video.models.raft.transforms.transforms import (ResizeImproved, ToFloat,
                                               ToTensorWithoutScaling)
from tqdm import tqdm
from mmkfeatures.video.utils.utils import (action_on_extraction, form_list_from_user_input,
                         reencode_video_with_diff_fps)

current_path = os.path.dirname(os.path.realpath(__file__)).replace("\\raft","")
RAFT_MODEL_PATH = {
    'sintel': current_path+'/raft/checkpoints/raft-sintel.pth',
    'kitti': current_path+'/raft/checkpoints/raft-kitti.pth',
}
