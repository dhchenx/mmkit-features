...
def which_ffmpeg() -> str:
    ...
    ffmpeg_path = result.stdout.decode('gbk',errors="ignore").replace('\n', '')
    return ffmpeg_path
...
def build_cfg_path(feature_type ="resnet18",root_configs="./configs") -> os.PathLike:
